...
[assembly: SuppressMessage("Design", "CA1062:Validate arguments of public methods", Justification = "<Pending>", Scope = "member", Target = "~M:StorageRepository.StorageRepo.LoadGame(System.String)~GameModel.Models.GameModell")]
[assembly: SuppressMessage("Globalization", "CA1305:Specify IFormatProvider", Justification = "<Pending>", Scope = "member", Target = "~M:StorageRepository.StorageRepo.LoadGame(System.String)~GameModel.Models.GameModell")]
[assembly: SuppressMessage("StyleCop.CSharp.ReadabilityRules", "SA1117:Parameters should be on same line or separate lines", Justification = "<Pending>", Scope = "member", Target = "~M:StorageRepository.StorageRepo.LoadGame(System.String)~GameModel.Models.GameModell")]
