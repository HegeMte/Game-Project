...
namespace FFYLife
{
    public  class Renderer
    {
        ...
        private Drawing GetUIBackground()
        {
                ...
                //FormattedText BlockCount = new FormattedText(this.model.Name.ToString(), CultureInfo.CurrentCulture, FlowDirection.LeftToRight, new Typeface("Arial"), 130, Brushes.Wheat);
                //Geometry geo5 = BlockCount.BuildGeometry(new Point(450, 50));
                //GeometryDrawing gd5 = new GeometryDrawing(Brushes.Black, Is, geo5);

                
                //FormattedText PlayerName = new FormattedText(this.model.Name.ToString(), CultureInfo.CurrentCulture, FlowDirection.LeftToRight, new Typeface("Arial"), 130, Brushes.Wheat);
                //Geometry geo6 = PlayerName.BuildGeometry(new Point(350, 50));
